...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 13 11:51:00 2022

A simple program that takes a sequence of numbers and sorts them in increasing order by using 'insertion sort' algorithm
